(function() {
  ...
  _.filter = function(collection, test) {
    var results = [];
      ...
      _.each(collection, function(value){
        //if the callback on the value evaluates to true;  
        if(test(value)){
  ...
  _.reject = function(collection, test) {
    ...
    _.filter(collection, function(val){
      if(!test(val)){
      //if it doesn't pass the truth test
        results.push(val);
        //push it into the results variable...
      }
    });
    return results;
...
_.uniq = function(array) {
  ...
  _.map = function(collection, iterator) {
    ...
    //loop through the array
    _.each(collection, function(value){
    //push the new values into new array varialbe, while running the callback
      results.push(iterator(value));
    });

  //return the new variable with the affected results
  return results;
  };
